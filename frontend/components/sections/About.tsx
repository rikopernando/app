...
export const About = () => {
  return (
    <section
      ...
      className="relative py-24 lg:py-32 bg-white border-t border-cream-200"
    >
          ...
          <div className="lg:col-span-7">
            ...
            <div className="mt-7 space-y-5 text-[16.5px] leading-relaxed text-ink-soft max-w-2xl">
              <p>
                ...
                Jaya, Kabupaten Lampung Barat. Sejak 1985, kami mendampingi
                anak-anak Sumber Jaya tumbuh menjadi pribadi yang percaya diri,
                penasaran, dan peduli.
              </p>
              <p>
                Dengan 46 guru dan tenaga kependidikan yang hangat, 15 ruang
                kelas yang nyaman, serta Kurikulum Merdeka — kami percaya setiap
                anak punya keunikan yang layak ditemukan, dirawat, dan
                dirayakan.
              </p>
            </div>
