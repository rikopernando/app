      ...
      <aside className="w-60 shrink-0 bg-white border-r border-cream-200 flex flex-col">
        ...
        <div className="p-4 border-t border-cream-200">
          <form action={signOut}>
            <button
              type="submit"
              className="flex items-center gap-3 w-full px-4 py-2.5 rounded-xl text-[13.5px] font-semibold text-ink-soft hover:text-coral hover:bg-coral-50 transition-colors"
            >
