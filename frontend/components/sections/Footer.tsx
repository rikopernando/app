      ...
      <div className="relative max-w-7xl mx-auto px-5 sm:px-8 lg:px-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 lg:gap-8 pb-10">
          ...
          <div className="md:col-span-4">
            <p className="text-[10.5px] tracking-[0.2em] uppercase text-coral-700 font-bold mb-5">Kontak</p>
          ...
          <div className="md:col-span-3">
            <p className="text-[10.5px] tracking-[0.2em] uppercase text-coral-700 font-bold mb-5">Jelajahi</p>
